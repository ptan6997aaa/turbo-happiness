...
try:
    ...
    print(f"Data Load Error (Using dummy data): {e}")
    # 假数据用于防止报错
    df = pd.DataFrame()
...
def build_bar_quarter(df_in, selected_quarter=None, global_mean=None, use_global_mean=False):
    ...
    vega_spec = {
        ...
        "title": {
            ...
            "subtitle": ["Average Score per Quarter vs. Overall Average"],
            "anchor": "start",
            "fontSize": 16,
            "subtitleFontSize": 12,
            "subtitleColor": "gray",
        ...
        "style": "cell",
        "data": [
            {"name": "data_0", "values": data_values},
            {
                "name": "data_1",
                "source": "data_0",
                "transform": [
